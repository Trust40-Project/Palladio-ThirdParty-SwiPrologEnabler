...
public class BasicQueriesTest {
	...
	public void testMember() {
		Variable x = new jpl.Variable("X");
		Term list = new Compound(".", new Term[] { new jpl.Float(1.1),
				new Compound(".", new Term[] { new jpl.Float(2.2), new Atom("[]") }) });

		Query query = new Query(new jpl.Compound("member", new jpl.Term[] { x, list }));
