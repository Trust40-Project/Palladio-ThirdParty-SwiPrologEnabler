...
// Added Koen Hindriks    
    public void setBB(BeliefBase bb) { curBB = bb; }
...
*/
 //   final public boolean agent(Agent a) throws ParseException, jason.JasonException {
    // modified Koen Hindriks
    final public boolean agent(BeliefBase bb) throws ParseException, jason.JasonException {
                                Literal b;
                                Literal g;
                                Plan    p;
                                //curAg = a;
...
//                                if (a != null) {
 ...
 //                                     a.addInitialBel(b);
      ...
      while (true) {
        ...
        endDir = false; // modified KH: directive(a);
                                if (endDir) {if (true) return false;}
      }
    }
    jj_consume_token(0);
