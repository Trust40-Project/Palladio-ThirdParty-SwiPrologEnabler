	...
	public Iterator<Unifier> logicalConsequence(
        ...
        try {
            ...
            */
            ...
            case not:
                if (!getLHS().logicalConsequence(bb,un).hasNext()) {
            ...
            case and:
                return new Iterator<Unifier>() {
                    Iterator<Unifier> ileft   = getLHS().logicalConsequence(bb,un);;
                    ...
                    private void get() {
                        ...
                        while ((iright == null || !iright.hasNext()) && ileft.hasNext())
                            iright = getRHS().logicalConsequence(bb, ileft.next());
                ...
                return new Iterator<Unifier>() {
                    ...
                    private void get() {
                        ...
                        if (ileft != null && ileft.hasNext())
                            ...
                            if (iright == null)
                                iright = getRHS().logicalConsequence(bb,un);
                            if (iright != null && iright.hasNext())
                                current = iright.next();
                        }
                    }
            ...
            String slhs = "is null ";
            Iterator<Unifier> i = getLHS().logicalConsequence(bb,un);
            if (i != null) {
                slhs = "";
                while (i.hasNext()) {
            ...
            String srhs = "is null ";
            if (!isUnary()) {
                i = getRHS().logicalConsequence(bb,un);
                if (i != null) {
                    srhs = "";
                    while (i.hasNext()) {
