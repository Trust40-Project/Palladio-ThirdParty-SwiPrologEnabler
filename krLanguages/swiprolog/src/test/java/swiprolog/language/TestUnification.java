...
// TODO
//		assertEquals(SWIPrologInterface.getInstance().getSubstitution(new HashMap<Var, Term>()).getJPLSolution(),
//				JPLUtils.mgu(a1,a2));
	...
	/**
	 * Test case: unification of variable X with term f(...) where ... does not contain X.
	 */
	@Test
