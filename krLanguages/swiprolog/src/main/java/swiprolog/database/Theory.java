...
public class Theory {
	 ...
	 *         otherwise.
	 */
	synchronized boolean add(DatabaseFormula formula) {
	 ...
	 */
	synchronized boolean add(Set<DatabaseFormula> content) {
	 ...
	 */
	synchronized boolean remove(DatabaseFormula formula) {
