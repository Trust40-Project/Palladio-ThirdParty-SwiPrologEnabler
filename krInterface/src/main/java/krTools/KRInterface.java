...
public interface KRInterface {
	 ...
	 *             If releasing resources was not successful or incomplete.
	 */
	 ...
	 *
	 * @param map
	 *            The Var to Term mapping; possibly null.
	 *
	 ...
	 * defined in the set of database formulas as well as those queries that are
