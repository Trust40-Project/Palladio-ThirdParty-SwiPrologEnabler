...
/**
 * A KR Database exception should be thrown in case a database could <i>not be created</i>,
 * if content in the database could <i>not be updated</i>, e.g., could not be added or
 * removed, or something <i>bad happened while destroying</i> the database.
 */
